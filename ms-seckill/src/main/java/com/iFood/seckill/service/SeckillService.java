package com.iFood.seckill.service;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.IdUtil;
import com.iFood.seckill.model.RedisLock;
import com.iFood.commons.constant.ApiConstant;
import com.iFood.commons.constant.RedisKeyConstant;
import com.iFood.commons.exception.ParameterException;
import com.iFood.commons.model.domain.ResultInfo;
import com.iFood.commons.model.pojo.SeckillVouchers;
import com.iFood.commons.model.pojo.VoucherOrders;
import com.iFood.commons.model.vo.SignInDinerInfo;
import com.iFood.commons.utils.AssertUtil;
import com.iFood.commons.utils.ResultInfoUtil;
import com.iFood.seckill.mapper.SeckillVouchersMapper;
import com.iFood.seckill.mapper.VoucherOrdersMapper;
...
public class SeckillService {
    ...
    public ResultInfo doSeckill(Integer voucherId, String accessToken, String path) {
        ...
        // 通过 restTemplate 调用 ms-oauth-server 服务的 /user/me 接口, 获取登录用户信息, 传递 accessToken, 返回 ResultInfo
    ...
    public void addSeckillVouchers(SeckillVouchers seckillVouchers) {
        ...
        // redisTemplate.opsForHash() 得到所有和hash相关的操作
        // redisTemplate.opsForHash().entries(key) return all entries in the hash stored at key，redis中hash存储的是键值对，不过这个值是一个map
        Map<String, Object> map = redisTemplate.opsForHash().entries(key);
        ...
        // BeanUtil.beanToMap() 将对bean转换为 Map
        // 将优惠券信息存入 Redis 中，key 为 seckill_vouchers:优惠券id, value 为优惠券信息(转换为 Map)
